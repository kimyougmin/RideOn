...
<template>
  <div class="flex gap-3 flex-col items-baseline">
    ...
    <div class="flex gap-4 items-center">
      <span class="text-sub-body1 text-black6 dark:text-black4">
        {{ riderCrew.createdAt }} 작성
      </span>
  ...
  <div class="flex flex-col gap-4">
    <p class="m-0 text-body1 dark:text-black3 leading-loose">{{ riderCrew.content }}</p>
    <div class="flex items-center gap-3">
      ...
      <span class="text-body1 dark:text-black3 font-light flex items-center gap-1">
