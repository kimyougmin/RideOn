...
<template>
  ...
  class="w-12 h-12 bg-black1 text-black1 dark:bg-black10 rounded-full 
         absolute top-8 left-14 shadow-xl flex items-center justify-center
  ...
  <span v-else>
    ...
    <div v-if="riderModal" class="absolute pb-5 w-[500px] h-[700px] bg-black1 rounded-3xl dark:bg-black9 left-12 top-28 shadow-2xl overflow-y-auto">
      <div class="flex flex-col h-full">
        <div class="h-1/3">
          <img src="https://images.unsplash.com/photo-1711333927567-754b6843ab67?q=80&w=2070&auto=format" class="w-full h-full object-cover rounded-t-3xl"/>
        </div>

        <div class="flex-2 mt-4 text-sm text-left ml-6 text-black10 dark:text-black1">
